...
<body>
    <div class="box">
        <form method="POST" action="connexionmembre.php">
            <span class="text-center">Connexion</span>
            <div class="connexion">

                <div class="input-container">
                    <input type="mail" name="mailconnect" id="mailconnect" placeholder="mail" />
                ...
                <span id="alerte"><?php $connexion = new Connect(); if (null !== $connexion->connexion()) { echo $connexion->connexion(); } ?></span>
                <br />
                <input type="submit" name="formconnexion" value="Se connecter" class="btn" />
                <br>
                <div class="Inscrit">
                    <a href="Inscriptionmembre.php">
